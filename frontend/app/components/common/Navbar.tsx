...
export default function Navbar() {
  ...
  const AvatarDropdownMenu = () => (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        className="w-48 mt-3 text-white dark:border-white/[0.2] border-transparent border bg-black"
      >
        ...
        <DropdownMenuItem asChild>
          <Link
            href="/pages/project"
            className="w-full cursor-pointer"
            onClick={() => handleNavigation("/pages/project")}
          >
            Publish
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link
            ...
            className="w-full cursor-pointer"
            onClick={() => handleNavigation("/pages/projectlist")}
          >
            Contribute
          </Link>
        </DropdownMenuItem>
        ...
        const guestLinks = () => (
          <>
            <button
              className="text-white bg-background rounded-md px-3 py-1 font-medium dark:border-white/[0.2] border-transparent border"
